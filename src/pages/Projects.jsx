        ...
        {projects.map((p, i) => (
          ...
          >
            <div className="flex items-start justify-between gap-4 mb-3">
              <div>
                <div className="flex items-center gap-3">
                  <h2 className="font-mono text-base font-semibold" style={{ color: '#f4f4f5' }}>
                    {p.title}
                  </h2>
                  {p.badge && (
                    <span
            ...
            <ul className="mb-4 space-y-1.5">
              {p.highlights.map((h) => (
                <li key={h} className="flex items-start gap-2 text-sm" style={{ color: '#a1a1aa' }}>
                  <span style={{ color: 'rgba(139,92,246,0.6)', marginTop: '2px', flexShrink: 0 }}>·</span>
                  {h}
                </li>
              ))}
            </ul>

...
const LINES = [
  ...
  },
  {
    x1: cx(POS.About.x),
    y1: cy(POS.About.y),
    x2: cx(POS.Projects.x),
    y2: cy(POS.Projects.y),
    delay: 0.2,
  },

  {
    x1: cx(POS.Projects.x),
    y1: cy(POS.Projects.y),
    x2: cx(POS.Skills.x),
    y2: cy(POS.Skills.y),
    delay: 0.35,
  },
  {
    x1: cx(POS.Projects.x),
    y1: cy(POS.Projects.y),
    x2: cx(POS.Achievements.x),
    y2: cy(POS.Achievements.y),
    delay: 0.35,
  },
  ...
  {
    x1: cx(POS.Achievements.x),
    y1: cy(POS.Achievements.y),
    x2: cx(POS.Contact.x),
    y2: cy(POS.Contact.y),
    delay: 0.5,
  },
